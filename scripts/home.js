document.addEventListener('DOMContentLoaded', () => {
  const slides = [
    { title: 'Facility Maintenance & Cleaning', text: 'Clean, compliant, and reliable facilities.', image: '../summit/images/facility.webp' },
    { title: 'Grounds Keeping', text: 'Safe, attractive outdoor spaces.', image: '../summit/images/garden.webp' },
    { title: 'PA & Audio Visual', text: 'Clear communication and event-ready systems.', image: '../summit/images/AV.webp' },
    { title: 'Remote Monitoring', text: 'Proactive oversight and smart alerts.', image: '../summit/images/security.webp' }
  ];
